...
namespace Graphs
{
    ...
    {
        public static (List<int>, List<int>) VectorOriented(this IGraph graph)
        {
        ...
        public static List<int> VectorNOriented(this IGraph graph)
        {
        ...
        public static int Rad(List<int> extr)
        {
            int Radius = 0;
            Radius = extr.Min();
            return Radius;
        }//Rad(int []extr)
        public static int Diameter(List<int> extr)
        {
            int Diameter = 0;
            Diameter = extr.Max();
            return Diameter;
        }//Diameter(int[] extr)
        public static List<int> CVert(List<int> extr)
        {
        ...
        public static List<int> PVert(List<int> extr)
        {
            List<int> vertices = new List<int>();
            for (int i = 0; i < extr.Count; i++)
            {
